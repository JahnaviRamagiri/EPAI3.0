# -*- coding: utf-8 -*-
"""Assignment S7 -epai.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19JTkTAVhJJ-QeGV8dim8aLU5oCk926xI
...
# 1: Write a closure that takes a function and then check whether the function passed has a docstring with more than
# 50 characters. 50 is stored as a free variable
def doc_check(fn):
